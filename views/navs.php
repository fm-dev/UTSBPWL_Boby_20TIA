                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div id="base-nav" class="mb-9">
                                <h2 class="h4">Base nav <a class="anchorjs-link" href="#base-nav" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
                                ...
                                <div class="alert alert-info mb-5" role="alert">
                                    ...
                                    <p class="alert-text mb-0">The base <code>.nav</code> component does not include any <code>.active</code> state. The following examples include the class, mainly to demonstrate that this particular class does not trigger any special styling.</p>
                                </div>

                                <div class="mb-3">
                                    <!-- Nav Classic -->
                                    <ul class="nav nav-v2 nav-primary d-block d-xl-flex" id="tabs-tab-0" role="tablist">
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3 active" id="tabs-result-tab-0" data-toggle="pill" href="#tabs-result-0" role="tab" aria-controls="tabs-result-0" aria-selected="true">Result</a>
                                        </li>
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3" id="tabs-html-tab-0" data-toggle="pill" href="#tabs-html-0" role="tab" aria-controls="tabs-html-0" aria-selected="false">HTML</a>
                                        </li>
                                    </ul>
                                    <!-- End Nav Classic -->

                                    <!-- Tab Content -->
                                    <div class="tab-content bg-lighter" id="tabs-tabContent-0">
                                        <div class="tab-pane fade py-4 show active" id="tabs-result-0" role="tabpanel" aria-labelledby="tabs-result-tab-0">
                                            <ul id="base1" class="nav mb-3" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="#base1-tab1" role="tab" aria-selected="true"
                                                       data-toggle="tab">Tab 1
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="#base1-tab2" role="tab" aria-selected="false"
                                                       data-toggle="tab">Tab 2
                                                    </a>
                                                </li>
                                            </ul>
                                            <div id="tabsContent1" class="card-body tab-content py-0 px-3">
                                                <div class="tab-pane fade show active" id="base1-tab1" role="tabpanel">
                                                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                                                </div>

                                                <div class="tab-pane fade" id="base1-tab2" role="tabpanel">
                                        ...
                                        <div class="tab-pane fade" id="tabs-html-0" role="tabpanel" aria-labelledby="tabs-html-tab-0">
<pre>
...
&lt;/div&gt;
                            ...
                            <div id="bootstrap-tabs" class="mb-9">
                                <h2 class="h4">Bootstrap Tabs <a class="anchorjs-link" href="#bootstrap-tabs" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
                                <p>Takes the basic nav from above and adds the <code>.nav-tabs</code> class to generate a tabbed interface. Use them to create tabbable regions with our tab JavaScript plugin.</p>

                                <div class="mb-3">
                                    <!-- Nav Classic -->
                                    <ul class="nav nav-v2 nav-primary d-block d-xl-flex" id="tabs-tab-1" role="tablist">
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3 active" id="tabs-result-tab-1" data-toggle="pill" href="#tabs-result-1" role="tab" aria-controls="tabs-result-1" aria-selected="true">Result</a>
                                        </li>
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3" id="tabs-html-tab-1" data-toggle="pill" href="#tabs-html-1" role="tab" aria-controls="tabs-html-1" aria-selected="false">HTML</a>
                                        </li>
                                    </ul>
                                    <!-- End Nav Classic -->

                                    <!-- Tab Content -->
                                    <div class="tab-content bg-lighter" id="tabs-tabContent-1">
                                        <div class="tab-pane fade py-4 show active" id="tabs-result-1" role="tabpanel" aria-labelledby="tabs-result-tab-1">
                                        ...
                                        <div class="tab-pane fade" id="tabs-html-1" role="tabpanel" aria-labelledby="tabs-html-tab-1">
<pre>
<code class="language-markup" data-lang="html">
&lt;div class=&quot;px-3&quot;&gt;
    &lt;ul id=&quot;tabs1&quot; class=&quot;nav nav-tabs mb-3&quot; role=&quot;tablist&quot;&gt;
...
&lt;/div&gt;
                            ...
                            <div id="bootstrap-pills" class="mb-9">
                                <h2 class="h4">Bootstrap Pills <a class="anchorjs-link" href="#bootstrap-pills" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
                                <p>Take that same HTML, but use <code>.nav-pills</code> instead:</p>

                                <div class="mb-3">
                                    <!-- Nav Classic -->
                                    <ul class="nav nav-v2 nav-primary d-block d-xl-flex" id="tabs-tab-2" role="tablist">
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3 active" id="tabs-result-tab-2" data-toggle="pill" href="#tabs-result-2" role="tab" aria-controls="tabs-result-2" aria-selected="true">Result</a>
                                        </li>
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3" id="tabs-html-tab-2" data-toggle="pill" href="#tabs-html-2" role="tab" aria-controls="tabs-html-2" aria-selected="false">HTML</a>
                                        </li>
                                    </ul>
                                    <!-- End Nav Classic -->

                                    <!-- Tab Content -->
                                    <div class="tab-content bg-lighter" id="tabs-tabContent-2">
                                        <div class="tab-pane fade py-4 show active" id="tabs-result-2" role="tabpanel" aria-labelledby="tabs-result-tab-2">
                                            <div class="px-3">
                                                <ul id="pills1" class="nav nav-pills mb-3" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" href="#pills1-tab1" role="tab" aria-selected="true"
                                                           data-toggle="tab">Tab 1
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="#pills1-tab2" role="tab" aria-selected="false"
                                                           data-toggle="tab">Tab 2
                                                        </a>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="tab-pane fade" id="tabs-html-2" role="tabpanel" aria-labelledby="tabs-html-tab-2">
<pre>
<code class="language-markup" data-lang="html">
&lt;div class=&quot;px-3&quot;&gt;
    &lt;ul id=&quot;pills1&quot; class=&quot;nav nav-pills mb-3&quot; role=&quot;tablist&quot;&gt;
...
&lt;/div&gt;
                            ...
                            <div id="gd-tabs" class="mb-9">
                                <h2 class="h4">Tabs <a class="anchorjs-link" href="#gd-tabs" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
                                <p>Take that same HTML, but add <code>.nav-v2</code> and other additional classes:</p>

                                <div class="mb-3">
                                    <!-- Nav Classic -->
                                    <ul class="nav nav-v2 nav-primary d-block d-xl-flex" id="tabs-tab-3" role="tablist">
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3 active" id="tabs-result-tab-3" data-toggle="pill" href="#tabs-result-3" role="tab" aria-controls="tabs-result-3" aria-selected="true">Result</a>
                                        </li>
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3" id="tabs-html-tab-3" data-toggle="pill" href="#tabs-html-3" role="tab" aria-controls="tabs-html-3" aria-selected="false">HTML</a>
                                        </li>
                                    </ul>
                                    <!-- End Nav Classic -->
...
&lt;/div&gt;
                            ...
                            <div id="gd-pills" class="mb-9">
                                <h2 class="h4">Pills <a class="anchorjs-link" href="#gd-pills" aria-label="Anchor" data-anchorjs-icon="#"></a></h2>
                                <p>Take that same HTML, but use <code>.nav-pills-v2</code> instead:</p>

                                <div class="mb-3">
                                    <!-- Nav Classic -->
                                    <ul class="nav nav-v2 nav-primary d-block d-xl-flex" id="tabs-tab-4" role="tablist">
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3 active" id="tabs-result-tab-4" data-toggle="pill" href="#tabs-result-4" role="tab" aria-controls="tabs-result-4" aria-selected="true">Result</a>
                                        </li>
                                        <li class="nav-item border-bottom border-xl-bottom-0">
                                            <a class="nav-link d-flex align-items-center py-2 px-3" id="tabs-html-tab-4" data-toggle="pill" href="#tabs-html-4" role="tab" aria-controls="tabs-html-4" aria-selected="false">HTML</a>
                                        </li>
                                    </ul>
                                    <!-- End Nav Classic -->

                                    <!-- Tab Content -->
                                    <div class="tab-content bg-lighter" id="tabs-tabContent-4">
                                        <div class="tab-pane fade py-4 show active" id="tabs-result-4" role="tabpanel" aria-labelledby="tabs-result-tab-4">
                                            <div class="px-3">
